...
const targetEmail = 'tejakarthi65@gmail.com';
...
async function confirmUserEmail() {
  ...
  console.log(`Found user: ${user.id}. Confirming email address...`);
  ...
  if (error) {
    ...
    console.log(`Successfully confirmed email for ${targetEmail}! You can now sign in.`);
  }
}
